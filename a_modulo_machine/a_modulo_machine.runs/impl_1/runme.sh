...
HD_PWD='C:/Users/ben/a_modulo_machine/a_modulo_machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mod.tcl -notrace
